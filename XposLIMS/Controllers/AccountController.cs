...
namespace XposLIMS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            var sUName = ConfigurationManager.AppSettings["SUserName"];
            if (model.UserName == sUName && model.Password == ConfigurationManager.AppSettings["SUserPwd"])
            {
                var claims = new[]
                {
                    new Claim("name", sUName),
        ...
        {
            ViewBag.Name = User != null && (User.Identity.IsAuthenticated && User.IsInRole("Admin"))
