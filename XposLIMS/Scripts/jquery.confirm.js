...
(function ($) {
     ...
     * @param [options] {{title, text, confirm, cancel, confirmButton, cancelButton, closeTimeout, post, submitForm, confirmButtonClass, modalOptionsBackdrop, modalOptionsKeyboard, modalIcon}}
     * @param [e] {Event}
     */
    $.confirm = function (options, e) {
        ...
        var modalIconHtml = '';
        if (settings.modalIcon) {
            modalIconHtml =
                '<img src="' + settings.modalIcon  + '">';
        }
                ...
                '<div class="confirmation-modal modal fade" tabindex="-1" role="dialog">' +
                    '<div class="'+ settings.dialogClass +'">' +
                        '<div class="modal-content">' +
                            modalHeader +
                            '<div class="modal-body">' + modalIconHtml + settings.text + '</div>' +
        ...
        if (parseInt(settings.closeTimeout) > 0) {
            setTimeout(function() {
                modal.remove();
            }, parseInt(settings.closeTimeout));
        }
    };
